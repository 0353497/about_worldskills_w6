...
class PageProvider extends GetxController {
  ...
  Widget get getSelectedPage {
    if (selectedPage.value == 0) return const AboutPage();
    if (selectedPage.value == 1) return const StatisticPage();
    if (selectedPage.value == 2) return const PhotosPage();
    if (selectedPage.value == 3) return const SkillsPage();
